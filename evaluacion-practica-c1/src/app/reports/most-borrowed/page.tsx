...
export default async function MostBorrowedPage() {
    let rows = [];
    try {
        const result = await query('SELECT * FROM vw_most_borrowed_books');
        rows = result.rows;
    } catch (error) {
    ...
    const topBook = rows.length > 0 ? rows[0].title : 'N/A';
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <header className="mb-8">
                    ...
                    <p className="text-gray-600">
                        Libros con mayor demanda histórica.
                    </p>
                </header>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-8 inline-block min-w-[200px]">
                    ...
                    <p className="text-4xl font-bold text-blue-600 mt-2">{topBook}</p>
                </div>
